...
from quantumion.compilerv2.rewriter import Chain
from quantumion.compilerv2.analog.rewrite.assign import AssignAnalogIRDim, VerifyAnalogCircuitDim, VerifyAnalogArgsDim
...
def assign_analog_circuit_dim(model):
    ...
    Post(VerifyAnalogCircuitDim(n_qreg = assignmed_model.n_qreg, n_qmode = assignmed_model.n_qmode))(assignmed_model)
