...
class VerificationNormalOrderFlow(FlowGraph):
    nodes = [
        VerificationFlowGraphCreator(verify = CanonicalizationVerificationNormalOrder(),
                                        transformer = NormalOrder())(name="normalorder"),
...
class VerificationFlow(FlowGraph):
    ...
    @forward_decorators.forward_once(done="NormalOrderFlow")
    def forward_gatherpauli(self, model):
        pass
