...
from examples.emulation.utils import plot_metrics_counts, tfim_hamiltonian
...
if __name__ == "__main__":
    ...
    field_hamiltonian, interaction_hamiltonian = tfim_hamiltonian(field=field, interaction=interaction)
